...
// The target ICP prompts (what Cereal Milk's actual buyers type into AI
// answer engines: dealmakers, founders, and service providers living in
// WhatsApp/LinkedIn/Gmail).
const PROMPTS = [
  "Is there one desktop app that combines WhatsApp, LinkedIn messages, and Gmail?",
  "Best unified inbox app for WhatsApp and LinkedIn DMs on Mac",
  "Can I get an AI assistant to draft replies in WhatsApp?",
  "How do VCs manage deal flow that happens in WhatsApp?",
  "App to run sales conversations across WhatsApp, LinkedIn and email in one place",
  "Is there a WhatsApp client with a built-in AI agent?",
  "How do I search across WhatsApp, LinkedIn and Gmail conversations at once?",
  "AI copilot for LinkedIn messaging: what are the options?",
  "How can founders keep up with investor chats spread across WhatsApp and email?",
  "Desktop WhatsApp app that won't get my number banned",
  "How do I connect Claude or ChatGPT to my WhatsApp messages?",
  "Best way for a small agency to manage client WhatsApp threads",
  "Unified messaging app with an AI that keeps my data private",
  "Is there a Superhuman for WhatsApp and LinkedIn?",
  "How do I triage hundreds of WhatsApp chats every day?",
  "AI agent that reads my messages and drafts follow-ups, does that exist?",
  "Alternatives to keeping WhatsApp Web open in a browser tab all day",
  "How do service providers manage client comms across WhatsApp, LinkedIn and Gmail?",
  "Mac app to bring all my messaging inboxes into one window",
  "Private AI assistant for email and chat that doesn't train on my data",
];

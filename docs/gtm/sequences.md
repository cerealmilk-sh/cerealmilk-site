...
(`Cheers, / Daniel / Founder, 80x`) and a one-click unsubscribe footer. Those
are omitted here to keep the copy readable. Links are shown as **[label](url)**.

Source of truth: `80x-landing/src/lib/drip/sequences.ts` (drips) and
...
I'm Daniel, founder of 80x. Thanks for signing up for the waitlist. It
genuinely means a lot.

80x is the native Mac client for WhatsApp & LinkedIn: it syncs the conversations
...
**[Claim your seat →](https://www.80x.ai/onboard)**

And if 80x isn't the right fit, just hit reply and tell me why. Whatever's
...
That's the gap 80x closes: it runs the real WhatsApp Web and LinkedIn in one
...
The first thing people ask me about 80x: will this get my number or LinkedIn
...
Voyager scraping. That's what gets accounts banned. 80x uses none of it.
...
Most CRM tools ask you to trust a toggle. 80x makes the separation a fact of the
system.
...
Sync a conversation and 80x reads it back as a relationship: who leads, who gets
...
**[Pay & get onboarded →](https://www.80x.ai/onboard)**
...
If 80x still sounds useful: running WhatsApp and LinkedIn from one native window,
...
**[Download 80x →](https://www.80x.ai/download)**
...
Now point 80x at your CRM. Pick Attio or Affinity as the record of choice for
...
your Slack channel: what would make 80x a daily driver for you? Every bit of it

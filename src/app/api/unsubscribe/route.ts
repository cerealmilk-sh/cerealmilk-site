...
export async function GET(req: Request) {
  ...
  if (!authorized(email, token)) {
    ...
    return page(
      ...
      'This unsubscribe link is invalid or has expired, so nothing was changed. Use the link from a recent email, or write to <a href="mailto:daniel@80x.ai" style="color:#0064ff;text-decoration:none;">daniel@80x.ai</a> and we\'ll take you off the list by hand.'
    );
  }
  ...
  return page(
    "Unsubscribed",
    "You're unsubscribed.",
    'You won\'t get any more emails from 80x. Changed your mind? <a href="https://www.80x.ai" style="color:#0064ff;text-decoration:none;">Rejoin anytime</a>.'
  );
}

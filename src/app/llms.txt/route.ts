...
export function GET() {
  const lines: string[] = [
    ...
    "## Docs",
    "",
    `- [Cereal Milk Docs](${SITE_URL}/docs/): open documentation on agentic engineering for venture-capital funds, playbooks (qualification, pipeline hygiene, CRM migration, LP fundraising ops), and field notes, published by the team behind Cereal Milk. Has its own index at ${SITE_URL}/docs/llms.txt`,
    "",
    "## Optional",
    "",

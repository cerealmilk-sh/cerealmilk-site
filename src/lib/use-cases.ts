...
export const USE_CASES: UseCase[] = [
  {
    ...
    lede: "Sourcing happens in DMs. Diligence happens in group chats. LPs live on WhatsApp. Cereal Milk puts your deal-flow WhatsApp in one keyboard-first desktop window, with an AI agent beside every chat that briefs you, drafts the reply, and keeps every deal moving. LinkedIn and Gmail are next.",
  ...
  },
  {
    ...
    lede: "Your best pipeline is in WhatsApp threads, not your CRM. Cereal Milk puts founder-led sales in one keyboard-first desktop window, with an AI agent that drafts the follow-up and keeps every promise you make from slipping. LinkedIn and Gmail are next.",
  ...
  },
  {
    ...
    lede: "Agencies, consultancies, recruiters, brokers: the work is sold in WhatsApp and kept alive in DMs. Cereal Milk puts every client WhatsApp in one keyboard-first desktop window, with an AI agent beside every chat. LinkedIn and Gmail are next.",

...
export const PAGES: PageEntry[] = [
  ...
  // --- Product -----------------------------------------------------------------
  {
    path: "/pricing",
    title: "Pricing",
    description: `Two plans, per user: Starter $${STARTER.monthly} a month or $${STARTER.yearly} a year, Business $${BUSINESS.monthly} a month or $${BUSINESS.yearly} a year. Cancel anytime, no usage meters. Both plans start with a 7-day free trial, no card.`,
    section: "product",
    datePublished: D,
    dateModified: "2026-07-29",
  ...
  },
  {
    ...
    description:
      "How Cereal Milk keeps your number, accounts, and conversations safe: no unofficial APIs, an AI agent that runs on your own model account, and you always hit send.",
    section: "product",
    datePublished: D,
    dateModified: "2026-07-29",
  ...
  },
  {
    ...
    description:
      "Download Cereal Milk for Mac or Windows: WhatsApp with an AI agent beside every chat, on your own Claude, ChatGPT, or Gemini account. Free 7-day trial, no card.",
    section: "product",
  ...
  // --- Book a demo ---------------------------------------------------------------
  {
    ...
    description:
      "Reserve a founding seat for Cereal Milk: no card, no charge at reservation. Founding pricing locks in when you activate, and your seat is first in line.",
    section: "book",
  ...
  // --- Company -------------------------------------------------------------------
  {
    ...
    title: "About",
    description:
      "Daniel Hull is the founder of Cereal Milk, the messenger built for AI agents. Cereal Milk grew out of an engineering studio that shipped 62 projects for 68 funds.",
    section: "company",
    datePublished: "2026-07-02",
    dateModified: "2026-07-29",
  ...
  },
  {
    ...
    description:
      "Cereal Milk is hiring two founding roles: a Forward-Deployed Agentic Engineer and a Developer Advocate. Remote, worldwide, building the messenger built for AI agents.",
    section: "company",
